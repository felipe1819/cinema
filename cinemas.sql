...
--
-- Host: 127.0.0.1
-- Generation Time: 03-Maio-2018 às 20:46
...
--
-- Estrutura da tabela `sala_sessao`
--
...
--
-- Extraindo dados da tabela `sala_sessao`
--

INSERT INTO `sala_sessao` (`idsala`, `filme_idfilme`, `cinema_idcinema`, `hora_i_f`) VALUES
(10, 5, 6, 'Inicio 10:00 à 12:00'),
(14, 7, 9, 'Inicio 13:00 a 14:00');
...
ALTER TABLE `cinema`
  ...
  ADD KEY `fk_cinema_cep_idx` (`cep_idendereco`);
...
ALTER TABLE `filme`
  ...
  ADD KEY `fk_filme_ator1_idx` (`ator_idelenco`),
  ADD KEY `fk_filme_diretor1_idx` (`diretor_iddiretor`);
...
--
-- Indexes for table `sala_sessao`
--
ALTER TABLE `sala_sessao`
  ADD PRIMARY KEY (`idsala`,`filme_idfilme`,`cinema_idcinema`),
  ADD KEY `fk_filme_has_cinema_cinema1_idx` (`cinema_idcinema`),
  ADD KEY `fk_filme_has_cinema_filme1_idx` (`filme_idfilme`);
...
--
ALTER TABLE `cinema`
  MODIFY `idcinema` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `diretor`
--
ALTER TABLE `diretor`
  MODIFY `iddiretor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
